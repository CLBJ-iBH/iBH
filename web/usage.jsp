      ...
      <nav class="amber darken-1" role="navigation">
        <div class="nav-wrapper container">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li class="active"><a href="#!" class="dropdown-button white-text" data-activates="dropdown1"><i class="material-icons left">trending_up</i><i class="material-icons right">arrow_drop_down</i>Usage History</a></li>
